		...
		<div style="float: left; width: 80%; height: 100%;">
			...
			<form id="" action="">
				<table width="70%" border="0" align="center" cellspacing="1"
					cellpadding="3">
					<tr>
						<th valign=middle align=center height=25
							background="images/bg2.gif" width=""><font color="#ffffff"><b>项目名称</b></font></th>
						<th valign=middle align=center height=25
							background="images/bg2.gif" width=""><font color="#ffffff"><b>项目类别</b></font></th>
						<th valign=middle align=center height=25
							background="images/bg2.gif" width=""><font color="#ffffff"><b>申请人</b></font></th>
						<th valign=middle align=center height=25
							background="images/bg2.gif" width=""><font color="#ffffff"><b>所在院系</b></font></th>
						<th valign=middle align=center height=25
							background="images/bg2.gif" width=""><font color="#ffffff"><b>指导教师</b></font></th>
						<th valign=middle align=center height=25
							background="images/bg2.gif" width=""><font color="#ffffff"><b>操作</b></font></th>
					</tr>
					<c:forEach items="${page.productList}" var="project">
						<tr>
							<td><input type="text" name=""
								value="${project.project_name}" readonly="readonly"></td>
							<td><input type="text" name=""
								value="${project.project_category}" readonly="readonly"></td>
							<td><input type="text" name=""
								value="${project.student_name}" readonly="readonly"></td>
							<td><input type="text" name="" value="${project.college}"
								readonly="readonly"></td>
							<td><input type="text" name="" value="${project.t_Name}"
								readonly="readonly"></td>
							<td><a
								href="projectXiangT?project_name=${project.project_name}"> <img
				...
				<div style="width: 100%; margin-top: 50px;" align="center">
					<ul
						...
						<c:if test="${page.currentPage!=1}">
							<li><a
								href="${pageContext.request.contextPath}/applyProjectT?currentPage=${page.currentPage-1}"
						...
						<c:forEach begin="1" end="${page.totalPage}" var="page1">
							...
							<c:if test="${page.currentPage!=page1}">
								<li><a
									href="${pageContext.request.contextPath}/applyProjectT?currentPage=${page1}">${page1}</a></li>
							</c:if>
							</li>
						</c:forEach>
