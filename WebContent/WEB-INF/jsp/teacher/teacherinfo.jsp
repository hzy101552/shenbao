...
<body bgcolor="#ccddee">
	...
	<div>
		...
		<div style="float: left; width: 80%; height: 100%;">
			<!-- 文件主体 -->
			<form id="updateInfoForm" action="updateT">
				<table width="400px" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="160px">教师工号：</td>
						<td><input type="text" name="snumber"
							value="${teacher.tnumber }" readonly="readonly"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="sex" value="${teacher.sex }"
							size="22" readonly="readonly"></td>
					</tr>
					<tr>
						<td width="160px">院系：</td>
						<td><input type="text" name="college"
							value="${teacher.college }" size="22" readonly="readonly"></td>
					</tr>
					<tr>
