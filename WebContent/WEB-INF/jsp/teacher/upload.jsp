...
<body bgcolor="#ccddee">
	...
	<div>
		...
		<div style="float: left; width: 80%; height: 100%;">
				...
				<table width="70%" border="0" align="center" cellspacing="1"
					...
					<tr>
						<th valign=middle align=center height=25
							background="images/bg2.gif" width=""><font color="#ffffff"><b>文件名称</b></font></th>
						<th valign=middle align=center height=25
							background="images/bg2.gif" width=""><font color="#ffffff"><b>上传者</b></font></th>
						<th valign=middle align=center height=25
							background="images/bg2.gif" width=""><font color="#ffffff"><b>上传者学号</b></font></th>
						<th valign=middle align=center height=25
			...
			<form id="tupload" action="tupload" method="post"
