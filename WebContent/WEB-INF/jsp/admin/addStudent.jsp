...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/addS.js"></script>
...
<body bgcolor="#ccddee">
	...
	<!-- 文件主体 -->
	<center>
	<form id="addStudent" action="addStudent" onsubmit="return checkAddS(this)">
	...
	<form id="upaddS" action="upaddS" method="post" enctype="multipart/form-data">
