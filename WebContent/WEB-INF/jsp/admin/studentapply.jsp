...
<body>
	...
	<form id="updateInfoForm" action="updateStudent">
	    <table width="400px" border="0" cellspacing="0" cellpadding="0">
	        <tr>
	            <td width="160px">学号：</td>
	            <td><input type="text" name="snumber" value="${student.snumber }" ></td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	            ...
	            <td><input type="text" name="sex" value="${student.sex }" size="22" ></td>
	        </tr>
	        <tr>
	            <td width="160px">院系班级：</td>
	            <td><input type="text" name="college" value="${student.college }" size="22" ></td>
	        </tr>
	        <tr>
	            <td width="160px">辅导员：</td>
	            <td><input type="text" name="tutor" value="${student.tutor }" size="22" ></td>
	        </tr>
	        <tr>
